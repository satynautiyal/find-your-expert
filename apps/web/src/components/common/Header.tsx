    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-40">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-8">
            <a href="/" className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-[#F15A24] text-white flex items-center justify-center shadow-xs">
              ...
              <div className="flex items-center text-lg sm:text-xl font-black tracking-tight text-gray-950">
                <span>FindYour</span>
                <span className="text-[#F15A24]">Experts</span>
              </div>
            </a>

            {/* Desktop Navigation Links */}
            <nav className="hidden lg:flex items-center gap-6 text-xs font-semibold text-gray-700 h-16">
              <div className="flex items-center gap-1 hover:text-[#F15A24] cursor-pointer py-2 transition-colors">
              ...
              <div className="relative flex items-center h-full text-gray-950 font-bold px-1 cursor-pointer">
                <span>Roofing</span>
                <div className="absolute bottom-0 left-0 right-0 h-[2.5px] bg-[#F15A24] rounded-t-full" />
              </div>

              <a href="#how-it-works" className="hover:text-[#F15A24] transition-colors py-2">
                How It Works
              </a>
              ...
              <a href="#for-contractors" className="hover:text-[#F15A24] transition-colors py-2">
                For Contractors
              </a>
            </nav>
          </div>
          ...
          <div className="hidden sm:flex items-center gap-5 text-xs font-semibold">
            <button className="flex items-center gap-1.5 text-gray-700 hover:text-gray-950 transition-colors">
              <Heart className={`w-4 h-4 ${savedCount > 0 ? 'fill-[#F15A24] text-[#F15A24]' : 'text-gray-400'}`} />
      ...
      {mobileMenuOpen && (
        <div className="sm:hidden border-t border-gray-200 bg-white px-4 py-3 space-y-2 text-xs font-semibold text-gray-800">
          ...
          <a href="#" className="block py-1.5 text-[#F15A24] font-bold">
            Roofing
          </a>
          <a href="#" className="block py-1.5">
            How It Works
